...
### Distirbution of Response Variable
...
sex <- alcfit_resid |> 
  ...
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "sex", y = "Residuals", title = "Residuals vs. sex") 

fjob <- alcfit_resid |> 
  ggplot(aes(x = Fjob, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "Fjob", y = "Residuals", title = "Residuals vs. Fjob") 

mjob <- alcfit_resid |> 
  ggplot(aes(x = Mjob, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "Mjob", y = "Residuals", title = "Residuals vs. Mjob") 

studytime <- alcfit_resid |> 
  ggplot(aes(x = studytime, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "studytime", y = "Residuals", title = "Residuals vs. studytime") 

absences <- alcfit_resid |> 
  ggplot(aes(x = absences, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "absences", y = "Residuals", title = "Residuals vs. absences") 

medu <- alcfit_resid |> 
  ggplot(aes(x = Medu, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "Medu", y = "Residuals", title = "Residuals vs. Medu") 

fedu <- alcfit_resid |> 
  ggplot(aes(x = Fedu, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "Fedu", y = "Residuals", title = "Residuals vs. Fedu") 

famsize <- alcfit_resid |> 
  ggplot(aes(x = famsize, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "famsize", y = "Residuals", title = "Residuals vs. famsize") 

reason <- alcfit_resid |> 
  ggplot(aes(x = reason, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "reason", y = "Residuals", title = "Residuals vs. reason") 

nursery <- alcfit_resid |> 
  ggplot(aes(x = nursery, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "nursery", y = "Residuals", title = "Residuals vs. nursery") 

famrel <- alcfit_resid |> 
  ggplot(aes(x = famrel, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "famrel", y = "Residuals", title = "Residuals vs. famrel") 

freetime <- alcfit_resid |> 
  ggplot(aes(x = freetime, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "freetime", y = "Residuals", title = "Residuals vs. freetime") 

goout <- alcfit_resid |> 
  ggplot(aes(x = goout, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "goout", y = "Residuals", title = "Residuals vs. goout") 

health <- alcfit_resid |> 
  ggplot(aes(x = health, y = resid)) + 
  geom_point() + 
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") + 
  labs(x = "health", y = "Residuals", title = "Residuals vs. health") 
...
\
Medu: +.345 - As each level of Mother's education increases by one unit the expected Walc score increases by .345 on average.

famrel: -.307 - As each level of quality of family relationship increases by one unit the expected Walc score decreases by -.307 on average.

goout: +.381 - As each level of going out with friends increases by one unit the expected Walc score increases by .381 on average.

sex_M: +.838 - If the individual is Male, the expected Walc score increases by .838 compared to the baseline of sex_W on average.

Mjob_services: -.737 - If the individual's Mother works in the civil services industry, the expected Walc score decreases by .737 compared to the baseline of Mjob_at_home on average.
