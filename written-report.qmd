...
\
Medu: +.34 - As each level of Mother\'s education increases by one unit the expected Walc score increases by .34 on average.

famrel: +.002 - As each level of quality of family relationship increases by one unit the expected Walc score increases by .002 on average.
...
sex_M:  +.872 - If the individual is Male, the expected Walc score increases by .872 on average.

Mjob_services: -.716 - If the individual\'s Mother works in the services industry, the expected Walc score decreases by .716 on average.
